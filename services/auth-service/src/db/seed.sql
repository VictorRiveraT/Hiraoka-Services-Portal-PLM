...
-- ============================================================
INSERT INTO tickets (
  id_ticket, codigo_ticket, id_cliente, id_producto, id_tecnico,
...
VALUES
  ...
  ('d1000000-0000-0000-0000-000000000001', 'TK-2026-001',
   'a1000000-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000001',
   NULL,
   'Recibido',
  ...
  ('d1000000-0000-0000-0000-000000000002', 'TK-2026-002',
   'a1000000-0000-0000-0000-000000000002',
   'c1000000-0000-0000-0000-000000000002',
   'b0000000-0000-0000-0000-000000000099',
   'Diagnosticando',
  ...
  ('d1000000-0000-0000-0000-000000000003', 'TK-2026-003',
   'a1000000-0000-0000-0000-000000000003',
   'c1000000-0000-0000-0000-000000000003',
   'b0000000-0000-0000-0000-000000000099',
   'Reparando',
  ...
  ('d1000000-0000-0000-0000-000000000004', 'TK-2026-004',
   'a1000000-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000004',
   'b0000000-0000-0000-0000-000000000099',
   'Listo',
  ...
  ('d1000000-0000-0000-0000-000000000005', 'TK-2026-005',
   'a1000000-0000-0000-0000-000000000002',
   'c1000000-0000-0000-0000-000000000005',
   'b0000000-0000-0000-0000-000000000099',
   'Entregado',
  ...
  ('d1000000-0000-0000-0000-000000000006', 'TK-2026-006',
   'a1000000-0000-0000-0000-000000000003',
   'c1000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000099',
   'Diagnosticando',
  ...
  ('d1000000-0000-0000-0000-000000000007', 'TK-2026-007',
   'a1000000-0000-0000-0000-000000000003',
   'c1000000-0000-0000-0000-000000000002',
   NULL,
   'Recibido',
  ...
  ('d1000000-0000-0000-0000-000000000008', 'TK-2026-008',
   'a1000000-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000005',
   'b0000000-0000-0000-0000-000000000099',
   'Reparando',
...
UPDATE tickets
SET codigo_ticket = CASE id_ticket
  WHEN 'd1000000-0000-0000-0000-000000000001' THEN 'TK-2026-001'
  WHEN 'd1000000-0000-0000-0000-000000000002' THEN 'TK-2026-002'
  WHEN 'd1000000-0000-0000-0000-000000000003' THEN 'TK-2026-003'
  WHEN 'd1000000-0000-0000-0000-000000000004' THEN 'TK-2026-004'
  WHEN 'd1000000-0000-0000-0000-000000000005' THEN 'TK-2026-005'
  WHEN 'd1000000-0000-0000-0000-000000000006' THEN 'TK-2026-006'
  WHEN 'd1000000-0000-0000-0000-000000000007' THEN 'TK-2026-007'
  WHEN 'd1000000-0000-0000-0000-000000000008' THEN 'TK-2026-008'
  ELSE codigo_ticket
END
WHERE id_ticket IN (
